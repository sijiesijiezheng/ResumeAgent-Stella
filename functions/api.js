...
请基于以下信息，为学生生成一份完整的中文简历，并在生成后进行自我检查与优化。
...
2. 优先基于用户提供的“相关经历”进行扩写，严禁编造不存在的经历。

3. 如果经历较少，可以适度补充，但必须合理且符合学生背景。

4. 根据用户选择的简历风格（style）调整表达方式。
...
请你扮演一位严格的HR，对刚才生成的简历进行检查，并指出问题。
...
请根据上述 Reviewer 的问题和优化建议，对简历进行重新优化生成最终版本。
